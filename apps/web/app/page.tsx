...
function IncidentDetail({ detail, session, canOperate, reviewBusy, actionError, onReview, onRemediate }: { detail: Detail; session: Session | null; canOperate: boolean; reviewBusy: boolean; actionError: string; onReview: (approved: boolean) => void; onRemediate: (beneficiaryRef: string, note: string) => void }) {
